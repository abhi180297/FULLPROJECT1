...
import './SuperAdminDashboard.css'; // Reusing same styles
  ...
  return (
    <div className="superadmin-dashboard">
      <div className="dashboard-header">
        ...
        <span className="welcome-text">Welcome - Sales Person.</span>
      ...
      <h1 className="dashboard-title"> Sales Person, HI</h1>
